    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                //Console.Write(pressedKey.KeyChar);//символьное обозначение клавиши 
        ...
        private static void HandleInput(ConsoleKeyInfo pressedKey, ref int pacmanY, ref int pacmanX, char[,] map, ref int score)
        {
